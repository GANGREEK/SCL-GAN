...
class SCModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        #macs, params = get_model_complexity_info(self.netG, (3, 256, 256), as_strings=True,
    ...
    def backward_G(self):
        ...
        self.loss_per2 = self.criterionFeature(self.real_B, self.fake_B)*15
        self.loss_L = self.criterionSyn(self.real_B, self.fake_B)*15
        self.T = self.Triplet.get_loss(self.real_B,self.fake_B,self.real_A)
        # identity loss
        if l_spatial_idt > 0:
        ...
        self.loss_G = self.loss_G_GAN + self.loss_style + self.loss_per + self.loss_G_s + self.loss_G_s_idt_B + self.loss_idt_B +self.loss_per2 + self.T + self.loss_L
